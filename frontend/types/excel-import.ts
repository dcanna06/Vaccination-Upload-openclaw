...
export const COLUMN_MAPPINGS: ExcelColumnMapping[] = [
  ...
  { excelColumn: 'Vaccine Type', fieldKey: 'vaccineType', required: false, conditional: 'NIP/OTH' },
  { excelColumn: 'Route of Administration', fieldKey: 'routeOfAdministration', required: false, conditional: 'PO/SC/ID/IM/NS' },
